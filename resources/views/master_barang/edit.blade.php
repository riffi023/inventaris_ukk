...
<div class="edit-card animate__animated animate__fadeIn">
    <div class="edit-header">
        <h5 class="mb-0">Edit Master Barang</h5>
        <p class="mb-0 text-white-50">Update informasi barang</p>
    </div>
    
    <div class="edit-body">
        <form action="{{ route('master_barang.update', $masterBarang->id_master_barang) }}" method="POST" id="editForm">
            @csrf
            @method('PUT')
            <div class="row g-4">
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('spesifikasi_teknis', $masterBarang->spesifikasi_teknis) }}"
                               maxlength="100"
                               required>
