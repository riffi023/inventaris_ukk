...
<div class="detail-card">
    <div class="detail-header">
        <h5 class="mb-0">
            <i class="fas fa-building me-2"></i>Detail Distributor
        </h5>
        <p class="mb-0 text-white-50">Informasi lengkap untuk distributor #{{ $distributor->id_distributor }}</p>
    </div>
    ...
    <div class="detail-body">
        ...
        <div class="text-center mt-4">
            <a href="{{ route('distributor.index') }}" class="btn btn-primary">
